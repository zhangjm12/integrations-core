    ...
    def _build_relations_config(self, yamlconfig):
        ...
        for element in yamlconfig:
            if isinstance(element, str):
                ...
                relation_name = element.get('relation_name')

                if relation_name is not None:
                    config[relation_name] = {'relation_name': relation_name, 'schemas': schemas}
                else:
                    relation_regex = element['relation_regex']
                    config[relation_regex] = {'relation_regex': relation_regex, 'schemas': schemas}
